...
//         _mint(address(this), 21000000 ether);
...
//         path[0] = WBNB;
//         path[1] = USDT;
//         uint[] memory price = router.getAmountsOut(msg.value, path);
//         uint256 _usdt = price[1];
//         require(_usdt != 0, "Insufficient USDT amount for BNB");

//         uint256 _token = 10500000 ether;
//         safeTransferFrom(USDT,msg.sender,address(this),_usdt);
//         require(IERC20(USDT).balanceOf(address(this)) == _usdt, "Insufficient USDT balance");
...
//         if(tradingEnable) {
//             if(block.timestamp > tradeStartTime + 3600) {
//                 maxPancakeBuy = 0;
//                 maxPancakeSell = 0;
//             }
//         }

//         if(from != address(this) && balanceOf(from) - amount < _minWallet) {
//             amount = balanceOf(from) - _minWallet;
//         }
...
//         amountOut = afterEthBalance - beforeEthBalance;
//     }
